...
"""
 代码来源：https://github.com/huggingface/accelerate/blob/main/examples/by_feature/deepspeed_with_config_support.py
 用途：解决deepspeed zero3时，accelerate库模型无法正确保存的问题，给出了解决样例
"""
