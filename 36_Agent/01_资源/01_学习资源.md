...
仓库还附了一份 Project Ladder，从 Level 1 的 Calculator Agent 到 Level 11 的 Production Harness，每级对应一个可运行项目。

Level 1-3 练基础：工具调用、搜索与引用、RAG。Level 4-6 进真实工程：code review agent、browser agent、Claude Code-like nano agent。Level 7-11 做架构：gateway、skill pack、multi-agent 协作、个人 agent、production harness。
